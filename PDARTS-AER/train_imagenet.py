...
def main():
    ...
    if os.path.exists(os.path.join(args.save, 'checkpoint.pth.tar')):
        init_epoch, model_state_dict, best_acc_top1, optimizer_state_dict = utils.load_checkpoint(args.save)
    else:
        init_epoch, model_state_dict, optimizer_state_dict = 0, None, None
